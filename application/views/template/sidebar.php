                        ...
                        <div class="pcoded-inner-navbar main-menu" style="display: block;margin: 10px 0;padding: 10px;width: 100%;">
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                ...
                                <li class="pcoded-hasmenu active pcoded-trigger">
                                    <a href="<?php echo base_url('koperasi_induk');?>">
                                        <span class="pcoded-micon"><i class="feather icon-sidebar"></i></span>
                                        <span class="pcoded-mtext">Data Induk</span>
                                    </a>
                                </li>
                                <li class="pcoded-hasmenu active pcoded-trigger">
                                    <a href="<?php echo base_url('koperasi_pusat');?>">
                                        <span class="pcoded-micon"><i class="feather icon-sidebar"></i></span>
                                        <span class="pcoded-mtext">Data Puskop</span>
                                    </a>
                                </li>
                                <li class="pcoded-hasmenu active pcoded-trigger">
                                    <a href="<?php echo base_url('koperasi_primer');?>">
                                        <span class="pcoded-micon"><i class="feather icon-sidebar"></i></span>
                                        <span class="pcoded-mtext">Data Primpkop</span>
                                    </a>
                                </li>
                                <li class="pcoded-hasmenu active pcoded-trigger">
                                ...
                                <li class="pcoded-hasmenu active pcoded-trigger">
                                    <a href="<?php echo base_url('gaada');?>">
