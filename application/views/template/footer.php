            ...
            <!--end of pcoded-container navbar-wrapper-->
        </div>
        <!--end of pcoded-->
        <div style="text-align: center; font:x-small"><h5><?php echo "Copyright&nbsp;&copy;".date('Y');?></h5></div>
...
<![endif]-->
    ...
    <script src="<?php echo base_url('assets/js/menu/menu-sidebar-fixed.js');?>"></script>
