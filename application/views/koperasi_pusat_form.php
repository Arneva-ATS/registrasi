                        ...
                        <div class="box-body col-xl-12 col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h2 style="margin-top:0px"><?php echo $button ?> Data Koperasi Pusat </h2>
                                </div>
                                <div class="card-block">
                                    <div class="container">
                                        <form action="<?php echo $action; ?>" method="post">
                                            <div class="did-floating-label-content">
                                                <input maxlength="6" readonly style="background-color:slategrey; color: #fff;" type="text" class="form-control-sm col-sm-6 did-floating-input" name="nisat" id="nisat" placeholder="NISAT" value="<?php if($button=='Tambah'){echo $lastnis;}else{echo $nisat;} ?>" />
                                                <label class="did-floating-label" for="nisat">Nisat <?php echo form_error('nisat') ?></label>
                                            </div>
                                            <div class="did-floating-label-content">
                                                <!-- <input maxlength="3" type="text" class="form-control-sm col-sm-6 did-floating-input" name="niki" id="niki" placeholder="Niki" value="<?php echo $niki; ?>" /> -->
                                            ...
                                            <div class="did-floating-label-content">
                                                <input type="text" class="form-control-sm col-sm-6 did-floating-input" name="nama_koperasi_pusat" id="nama_koperasi_pusat" placeholder="Nama Koperasi Pusat" value="<?php echo $nama_koperasi_pusat; ?>" />
                                                <label class="did-floating-label" for="nama_koperasi_pusat">Nama Koperasi Pusat <?php echo form_error('nama_koperasi_pusat') ?></label>
                                            </div>
                                            <div class="did-floating-label-content">
                                            ...
                                            <a href="<?php echo site_url('koperasi_pusat') ?>" class="btn btn-default">Batal</a>
                                        </form>
                                    </div>
                                </div>
                            </div>
